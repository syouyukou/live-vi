...
export const UI_STRINGS = {
  ...
  "preset.noPath": { en: "No path", zh: "無路徑" },
  ...
  "error.invalidElementSvg": {
    en: "Could not read this SVG. Export from Illustrator as SVG with vector paths (Object → Expand, not embedded images).",
    zh: "無法讀取此 SVG。請從 Illustrator 匯出向量 SVG（物件 → 展開，勿嵌入點陣圖）。",
  },
  "section.element": { en: "Element", zh: "元素" },
  "label.elementPreset": { en: "Preset", zh: "預設" },
  "label.elementA": { en: "Element A", zh: "元素 A" },
  "label.elementB": { en: "Element B", zh: "元素 B" },
  "label.elementBEnable": { en: "Enable second element", zh: "啟用第二元素" },
  "label.elementBOffsetX": { en: "Offset X", zh: "偏移 X" },
  "label.elementBOffsetY": { en: "Offset Y", zh: "偏移 Y" },
  "label.elementBRotate": { en: "Rotate", zh: "旋轉" },
  "label.elementBScale": { en: "Scale", zh: "縮放" },
  ...
  "label.mouseDirectionMode": { en: "Direction mode", zh: "方向模式" },
  "mouseMode.toward": { en: "Toward cursor", zh: "朝向游標" },
  "mouseMode.motion": { en: "Along motion", zh: "沿運動方向" },
  "mouseMode.blend": { en: "Blend", zh: "混合" },
  "mouseMode.perpendicular": { en: "Perpendicular", zh: "垂直運動" },
  "label.mouseFollowDirection": { en: "Follow direction", zh: "跟隨方向" },
  "label.mouseDirectionInfluence": { en: "Direction influence", zh: "方向強度" },
  "label.mouseSpeedStretch": { en: "Speed stretch", zh: "速度拉伸" },
  "label.mouseSpeedScale": { en: "Speed scale", zh: "速度縮放" },
  "label.mouseTrailStretch": { en: "Trail stretch", zh: "尾跡拉伸" },
  "label.mouseSmoothing": { en: "Smoothing", zh: "平滑度" },
  "label.mouseSpeedAnim": { en: "Speed → animation", zh: "速度推動畫" },
